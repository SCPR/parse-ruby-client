...
module Farse
  ...
  class Pointer
    ...
    def get
      Farse.get @class_name, @parse_object_id if @parse_object_id
    end
  ...
  # File
  # ------------------------------------------------------------
  # tf = Farse::File.new(:body => "Hello World!", :local_filename => "hello.txt")
  # tf.save
  class File
    ...
    def save
      uri = Farse::Protocol.file_uri(@local_filename)
      resp = Farse.client.request(uri, :post, @body, nil, @content_type)
